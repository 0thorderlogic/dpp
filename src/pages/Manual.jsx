function Manual() {
  return (
    <div className="container manual-wrapper">
      <div className="manual-toc">
        <h3>Contents</h3>
        <ul>
          <li><a href="#overview">Overview</a></li>
          <li><a href="#prereqs">Before You Start</a></li>
          <li>
            <a href="#inputs">Understanding Inputs</a>
            <ul>
              <li><a href="#inputs-motors" className="toc-h3">Motors</a></li>
              <li><a href="#inputs-props" className="toc-h3">Propellers</a></li>
              <li><a href="#inputs-battery" className="toc-h3">Battery</a></li>
              <li><a href="#inputs-esc" className="toc-h3">ESC</a></li>
              <li><a href="#inputs-electronics" className="toc-h3">Electronics</a></li>
              <li><a href="#inputs-params" className="toc-h3">Flight Parameters</a></li>
            </ul>
          </li>
          <li>
            <a href="#results">Understanding Results</a>
            <ul>
              <li><a href="#results-stats" className="toc-h3">Stats Cards</a></li>
              <li><a href="#results-graphs" className="toc-h3">Graphs Explained</a></li>
            </ul>
          </li>
          <li><a href="#tutorial">Step-by-Step Guide</a></li>
          <li><a href="#mistakes">Common Mistakes</a></li>
          <li><a href="#examples">Real Examples</a></li>
          <li><a href="#troubleshooting">Troubleshooting</a></li>
          <li><a href="#reference">Quick Ref Card</a></li>
        </ul>
      </div>
      ...
      <div className="manual-content">
        ...
        <h2 id="overview">What Is This Thing?</h2>
        <p>
        ...
        <h1 id="inputs">Understanding Each Input</h1>

        <h2 id="inputs-motors">MOTORS</h2>
        ...
        <h2 id="inputs-props">PROPELLERS</h2>
        ...
        <h2 id="inputs-battery">BATTERY</h2>
        ...
        <h2 id="inputs-esc">ESC (Electronic Speed Controller)</h2>
        ...
        <h2 id="inputs-electronics">ELECTRONICS & OTHER PARTS</h2>
        ...
        <h2 id="inputs-params">FLIGHT PARAMETERS</h2>
        ...
        <h1 id="results">Understanding the Results</h1>

        <h2 id="results-stats">Top Stats Cards</h2>
        ...
        <h2 id="results-graphs">The Graphs Explained</h2>
        ...
        <h1 id="tutorial">Step-by-Step: Your First Build Check</h1>
        ...
        <h1 id="mistakes">Common Mistakes to Avoid</h1>
        ...
        <h1 id="examples">Real Examples</h1>
        ...
        <h1 id="reference">Quick Reference Card</h1>
